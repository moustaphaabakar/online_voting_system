...
<div class="navbar">
	...
	<div id="element" class="hero-body">
	  <div class="thumbnail_gallery">
			  ...
			  <h2>Mission</h2>
			  <p>International University of Africa serving as a training ground for education students,seeks to develop in excellence
			  and with quality, the total personality of students and youth become worthy members of sociaty.
			  </p>
	...
	<button type="button" class="close" data-dismiss="modal">�</button>
	  ...
	  <div class="modal-body">
	   <h2>UIA Of Education Mission</h2>
<p><font color="black">
The International University of Africa as a leading training center for globally competitive professional teachers and spreading of islam arround the world
</p>	  

	   <h2>UIA Education Vission</h2>
<p><font color="black">
Vision Train and develop highly motivated and committed professional  teachers equipped with instructional,personal and social competencies conducive to teh task of human development.
</p>	 
	  </div>
	  <div class="modal-footer">
	    <a href="#" class="btn" data-dismiss="modal">Close</a>
			   ...
			   <h2>Objectives</h2><p>High Level</p>
			  <p>*develop an Enlightened commitment to the UIA ideals by cherishing,
	...
	<button type="button" class="close" data-dismiss="modal">�</button>
	 ...
	 <p>
	 * Provide learning experiences which increase the student�s awareness of the responsiveness to the change and just demands of society and to prepare him/her for constructive and effective environment.
	 </p>
	 <p>
	 * Promotes and intensify the student�s knowledge and identification with and love for the people and nation to which he/she belongs.
	 </p>
	 <p>* Promote work experiences which develop and enhance the student�s orientation to the world of work and creativity to prepare him to engage and honest and spiritual work
	 </p>
	 </div>
	  <div class="modal-footer">
	    <a href="#" class="btn" data-dismiss="modal">Close</a>
