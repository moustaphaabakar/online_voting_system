...
$rep2=$_POST['rep2'];
mysqli_query($conn,"insert into votes (CandidateID)values('$rep2')")or die(mysqli_error($conn));

$rep3=$_POST['rep3'];
mysqli_query($conn,"insert into votes (CandidateID)values('$rep3')")or die(mysqli_error($conn));
...
<body>
	...
	<a class="brand">
	 ...
	 <div class="chmsc_nav"><font size="4" color="white">International University of Africa</font></div>
 	</a>
